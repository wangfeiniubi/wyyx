...
(()=>{
    ajax({
        type:"get",
        url:"data/get_Products/get_Products_Name.php?cid=8",
        dataType:"json"
    }).then(resData=>{
...
(()=>{
    ajax({
        type:"get",
        url:"data/get_Products/wy_Food_Products.php",
        dataType:"json"
    }).then(function(resData){
        var fs = ['gd','xs','jgch','gg','cy','mc','rzp','sc','dw','sx','js'];
        for(var d of resData){
            ...
            for(var p of rows){
             ...
             document.querySelector("#"+fs[fid-61]+" .m-itemList").innerHTML=html;
...
$(window).scroll(function(){
    ...
    var floor1 = $("#gd").offset().top;
    var floor2 = $("#xs").offset().top;
    var floor3 = $("#jgch").offset().top;
    var floor4 = $("#gg").offset().top;
    var floor5 = $("#cy").offset().top;
    var floor6 = $("#mc").offset().top;
    var floor7 = $("#rzp").offset().top;
    var floor8 = $("#sc").offset().top;
    var floor9 = $("#dw").offset().top;
    var floor10 = $("#sx").offset().top;
    var floor11 = $("#js").offset().top;
