...
(()=>{
    ajax({
        type:"get",
        url:"data/get_Products/get_Products_Name.php?cid=5",
        dataType:"json"
    }).then(resData=>{
    ...
    ajax({
        ...
        for(var d of resData){
            ...
            for(var p of rows){
             ...
             document.querySelector("#"+fs[fid-39]+" .m-itemList").innerHTML=html;
...
$(window).scroll(function(){
    ...
    var floor1 = $("#ssdq").offset().top;
    var floor2 = $("#cfdq").offset().top;
    var floor3 = $("#ghjj").offset().top;
    var floor4 = $("#sm").offset().top;
    var floor5 = $("#yyyl").offset().top;
